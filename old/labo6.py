...
plt.plot(theta, I_diffraction, label="Diffraction (un fente)", linewidth=1)
plt.plot(theta, I_interference_diffraction, label="Interférencediffraction (deux fentes)", linewidth=1)
plt.title("InterférenceDiffraction")
plt.xlabel(" θ (rads)")
plt.ylabel("I/I0")
plt.legend()
plt.grid(True)
